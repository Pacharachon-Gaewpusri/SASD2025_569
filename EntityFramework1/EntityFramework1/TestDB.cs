...
public class TestDB
{
    ...
    void Read(MyDbContext context)
    {
        ...
        Console.WriteLine("----");
        //context.  // todo
        context.Addresses.ToList().ForEach(Console.WriteLine);
        Console.WriteLine("----");
        context.Telephones.ToList().ForEach(Console.WriteLine);

        Console.WriteLine("\n----Query some rows----");
        var list = context.Customers.Where(c => c.Id < 3).ToList();
        //var list = context.Customers.OrderBy(c => c.FirstName).ToList();
    ...
    void ClearAndInit(MyDbContext context)
    {
        ...
        context.Telephones.ExecuteDelete();
        ...
        context.Telephones.Add(new Telephone(1, 1, "888-8888"));
        context.Telephones.Add(new Telephone(2, 2, "999-9999"));
...

    {
        ...
        context.Customers.Add(new Customer(3, "Jane", "White"));
...

    {
        ...
        context.Customers.Remove(new Customer() { Id = 3 });
...

    {
        ...
        var cust = context.Customers.Where(c => c.Id == 3).Single();
